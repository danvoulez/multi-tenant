  ...
  return (
    <>
      <Hero
        ...
        capsuleLink="https://github.com/danvoulez/multi-tenant"
        title="A Multi-tenant Next.js Starter Template"
        subtitle="Built for developers, by developers. Next.js + Shadcn UI + LogLineOS."
        primaryCtaText="Get Started"
        primaryCtaLink="/auth/signup"
        secondaryCtaText="GitHub"
        secondaryCtaLink="https://github.com/danvoulez/multi-tenant"
        credits={
          <>
            Crafted with ❤️ by{" "}
            <a
              href="https://github.com/danvoulez"
              target="_blank"
              rel="noreferrer"
              className="underline"
            >
